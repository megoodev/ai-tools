  ...
  return (
    <header className="container py-2">
      <div className="flex justify-between gap-5">
        ...
        <nav className={`  ${open ? 'absolute inset-0 ' : 'hidden'} z-20 md:static absolute bottom-0   bg-black/50 md:bg-transparent md:flex justify-center items-center pt-15 md:pt-0`}>
